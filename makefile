...
CFLAGS = -c -ggdb -Wall
FFLAGS = -ggdb -Wall
MAIN: main.c file.o mapping.o maps.o menu.o menu_map_editor.o menu_start.o round.o
	$(CC) $(FFLAGS) main.c file.o mapping.o maps.o menu.o menu_map_editor.o menu_start.o round.o -o $@ -lncurses

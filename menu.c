...
static void draw_menu (int qt, int cur_pos, struct menu_option *options) {
	...
	int corner_y;			//the first option line
	int high = 2 * qt;		//? ?! 2 rows per option ?
	int i;
	int m;
	char *name = options -> option_name;
